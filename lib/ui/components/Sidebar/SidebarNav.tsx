              ...
              {(handleClick, open) => {
                return (
                  <>
                    <div
                      role="button"
                      className={`group cursor-pointer select-none relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      ...
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        <li>
                          <Link
                            ...
                            aria-disabled={pathname === "/forms/form-elements"}
                            tabIndex={
                              pathname === "/forms/form-elements"
                                ? -1
                                : undefined
                        ...
                        <li>
                          <Link
                            ...
                            aria-disabled={pathname === "/forms/form-layout"}
                            tabIndex={
                              pathname === "/forms/form-layout" ? -1 : undefined
                            }
                          >
                            Form Layout
                          </Link>
          ...
          <ul className="mb-6 flex flex-col gap-1.5">
            ...
            <SidebarLinkGroup
              activeCondition={
                ...
                pathname.includes("my-inventory")
              }
            >
              {(handleClick, open) => {
                return (
	...
	z M222.832,22H223V2H34v20L2,54h252L222.832,22z"
                    ...
                    >
                      <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                        ...
                        <li>
                          <Link
                            href="/my-inventory/add"
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                              pathname === "/my-inventory/add" &&
                              "text-white pointer-events-none"
                            } `}
                            aria-disabled={pathname === "/"}
                            tabIndex={pathname === "/" ? -1 : undefined}
                        ...
                        <li>
                          <Link
                            href="/my-inventory/edit"
                            aria-disabled={pathname === "/my-inventory/edit"}
                            tabIndex={
                              pathname === "/my-inventory/edit" ? -1 : undefined
                            }
                            className={`group relative flex items-center gap-2.5 rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                              pathname === "/my-inventory/edit" &&
                              "text-white pointer-events-none"
                            } `}
                          >
                            Edit
